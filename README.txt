     Debian GNU/Linux 13.1.0 "Trixie" - Official amd64 DVD Binary-1 with
                           firmware 20250906-10:24
...
===============
   ...
   which means that this disc is number 1 of a set of 28 discs . It
   ...
   disc. The other discs, up to Binary-28, contain mostly
   special-interest programs.

   The Release Notes for "trixie" are available on the Debian web site.
